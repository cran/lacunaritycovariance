...
#' @param lambda Intensity of the Poisson point process, passed to \link[spatstat.random]{rpoispp}.
#'   It could be either a single positive number, or any other object that \link[spatstat.random]{rpoispp} can understand.
